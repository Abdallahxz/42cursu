...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/09 20:20:07 by aassaad-          #+#    #+#             */
/*   Updated: 2024/03/10 12:22:43 by aassaad-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_col_up(int **matrix, int pos[2], int n, int *value)
{
	...
	if ((pos[0] == n - 1 && value[pos[1]] == count_view) || (pos[0] != n - 1
			&& value[pos[1]] >= count_view))
		return (1);
	return (0);
}
...
int	ft_is_valid(int **matrix, int pos[2], int n, int *value)
{
	...
	j = 0;
	if (!check_col_up(matrix, pos, n, value) || !check_col_down(matrix, pos, n,
			value) || !check_row_left(matrix, pos, n, value)
